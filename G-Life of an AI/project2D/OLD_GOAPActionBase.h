...
public:
	...
	inline std::vector<OLD_WorldStateProperty> GetPreConditionList() { return m_PreConditionList; };
	inline std::vector<OLD_EGOAPSymbols> GetEffectList() { return m_EffectList; };
...
protected:
	...
	std::vector<OLD_WorldStateProperty> m_PreConditionList;
	std::vector<OLD_EGOAPSymbols> m_EffectList;
